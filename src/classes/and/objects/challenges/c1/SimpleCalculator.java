...
public class SimpleCalculator {
    ...
    public void setFirstNumber(double valueFirstNumber) {
        this.firstNumber = valueFirstNumber;
    }

    public void setSecondNumber(double valueSecondNumber) {
        this.secondNumber = valueSecondNumber;
    }
